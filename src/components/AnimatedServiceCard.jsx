...
export default function AnimatedServiceCard({ title, description, index }) {
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-white rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
